...
<div class="admin-toolbar" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    ...
    <div class="search-box">
        <form id="searchForm" class="search-form" style="display: flex; gap: 10px; align-items: center;">
            ...
            <input type="text" id="filterKeyword" class="search-input" placeholder="Tìm tên bài, tóm tắt..." style="width: 200px;">
            <button type="submit" id="btnFilter" class="btn btn-OK">🔍 Tìm Kiếm</button>
