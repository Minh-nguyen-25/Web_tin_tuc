...
async function loadNews() {
    ...
    const filterKeyword = document.getElementById('filterKeyword') ? encodeURIComponent(document.getElementById('filterKeyword').value.trim()) : '';
    ...
    try {
        const response = await fetch(BASE_URL + 'api/news?category_id=' + filterId + '&keyword=' + filterKeyword);
